    ...
    $.fn.lightBox = function (settings) {
		...
		(function(){
		  settings.trigger.click(function(e){ 
			...
			if(link=="#"){ 
		      jQueryMatchedObj=settings.getGallery.call(this,this);
		      _start(jQueryMatchedObj[0],jQueryMatchedObj);
			  return false;
			} 
		  }); 
		})(); 
        ...
        */
        function _start(objClicked, jQueryMatchedObj) {
            ...
            if (jQueryMatchedObj.length == 1) {
                settings.imageArray.push(new Array(objClicked.getAttribute('href'), objClicked.getAttribute('lang')));
            } else {
                // Add an Array (as many as we have), with href and title atributes, inside the Array that storage the images references		
                for (var i = 0; i < jQueryMatchedObj.length; i++) {
                    settings.imageArray.push(new Array(jQueryMatchedObj[i].getAttribute('href'), jQueryMatchedObj[i].getAttribute('lang')));
                }
            }
        ...
        */
        function _set_interface() {
            ...
            $('#jquery-overlay,#jquery-lightbox').click(function (e) {
			    ...
			    if(id=="lightbox-nav-btnPrev"||id=="lightbox-nav-btnNext"||id=="lightbox-image")
				  return false;
                _finish();
            });
