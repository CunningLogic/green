var PageManager = {
  ...
  bindEvent: function () {
    ...
    navUL.delegate("a", "click", function () {
      ...
      if (targetEle) {
        ...
        $('html, body').animate({ scrollTop: top - 40}, 1000, 'easeOutExpo', function () {
          isScrolling = false;
        });
        return false;
      }
  ...
  initComponent: function () {
    //===lightBox组件
    $.fn.lightBox({
      imageLoading: '/images/work/f2e/lightbox-ico-loading.gif',
      imageBtnPrev: '/images/work/f2e/prev.png',
      imageBtnNext: '/images/work/f2e/next.png',
      imageBtnClose: '/images/work/f2e/lightbox-btn-close.gif',
