...
;(function($, window, document, Math, undefined) {
  ...
  $.fn.fullpage = function(options) {
    ...
    FP.moveSectionUp = function(){
      ...
      }else{//call onOver if over slide
        if(canScroll && !options.over && $.isFunction(options.onOver)){
          canScroll=false;
          options.over='top';
          options.onOver.call(this,'out','top',function(){
            canScroll=true;
          });
        }
      }
    ...
    FP.moveSectionDown = function (){
      ...
      if(next.length){
        ...
        if(canScroll && !options.over && $.isFunction(options.onOver)){
          canScroll=false;
          options.over='bottom';
          options.onOver.call(this,'out','bottom',function(){
            canScroll=true;
          });
        }
      }
    ...
    $(SECTION_SEL).each(function(index){
      ...
      if(options.scrollOverflow){
        ...
        $.isFunction( options.afterRender ) && options.afterRender.call(container,options);
      }
    ...
    function createSlimScrollingHandler(){
      ...
      $.isFunction( options.afterRender ) && options.afterRender.call( this,options);
    }
    ...
    function scrolling(type, scrollable){
      ...
      var dir=type=='down'?'bottom':'top';
      if(canScroll&&options.over&&options.over!=dir) {
        if($.isFunction(options.onOver)) {
          canScroll=false;
          options.onOver.call(this,'in',options.over,function(){
            canScroll=true;
          });
          options.over='';
          return false;
    ...
    function MouseWheelHandler(e) {
      ...
      if(options.autoScrolling){
        ...
        //scroll in from over dir(top|bottom)
        var dir=delta < 0?'bottom':'top';
        if(canScroll&&options.over&&options.over!=dir) {
          if($.isFunction(options.onOver)) {
            canScroll=false;
            options.onOver.call(this,'in',options.over,function(){
